    ...
    <div className="min-h-screen bg-gradient-to-br from-[#F4F6FB] via-[#FAF7F0] to-[#F1F7F3] font-sans">
      <header className="flex items-center justify-between px-8 py-5">
        <div className="flex items-center gap-2">
          <div className="w-10 h-10 rounded-xl flex items-center justify-center shadow-md" style={{ background: GOLD }}>
            <Sprout size={19} className="text-white" />
          </div>
          <span className="font-serif font-bold text-lg" style={{ color: NAVY }}>AgriHakStat</span>
        </div>
